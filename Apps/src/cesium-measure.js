            ...
            drawLineMeasureGraphics: function (options = {}) {
                ...
                if (this._viewer && options) {
                    ...
                    function _addInfoPoint(position) {
                        ...
                        _labelEntity.label = {
                            text: $this.getPositionDistance($this.transformCartesianArrayToWGS84Array(positions))  + 'm',
                            show: true,
                            showBackground: true,
                            font: '14px monospace',
            ...
            drawAreaMeasureGraphics: function (options = {}) {
                ...
                if (this._viewer && options) {
                    ...
                    function _addInfoPoint(position) {
                        ...
                        _labelEntity.label = {
                            text: $this.getPositionsArea($this.transformCartesianArrayToWGS84Array(positions)) + 'sq.m',
                            show: true,
                            showBackground: true,
                            font: '14px monospace',
                            horizontalOrigin: Cesium.HorizontalOrigin.LEFT,
                ...
                if (this._viewer && options) {
                    ...
                    _trianglesEntity.label = {
                        text: new Cesium.CallbackProperty(function () {
                            return 'line:' + $this.getPositionDistance($this.transformCartesianArrayToWGS84Array(_positions)) + 'm'
                        }, false),
                        show: true,
                        showBackground: true,
                        font: '14px monospace',
                    ...
                    _tempLineEntity2.label = {
                        text: new Cesium.CallbackProperty(function () {
                            return 'Horizontal distance:' + $this.getPositionDistance($this.transformCartesianArrayToWGS84Array(_tempPoints2)) + 'm'
                        }, false),
                        show: true,
                        showBackground: true,
                        font: '14px monospace',
